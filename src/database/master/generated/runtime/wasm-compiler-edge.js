...
function Wi(e, t) {
    ...
    if (
        ...
        for (
            i = d.length, a = v.length, P = i < a, P && (a = i), i = 0;
            i < a;
            i++
        )
            if (d[i] != v[i]) {
    ...
    zi = fe(() => {
        ...
        A.toPrecision = function (e, t) {
            ...
            return (
                e === void 0
                    ? ((r = J(i)),
                      (n = Ve(i, r <= o.toExpNeg || r >= o.toExpPos)))
                    : (ye(e, 1, Xe),
                      t === void 0 ? (t = o.rounding) : ye(t, 0, 8),
                      (i = _(new o(i), e, t)),
                      (r = J(i)),
            ...
            case "join": {
                ...
                let a = await Promise.all(
                    t.args.children.map(async (d) => ({
                        joinExpr: d,
                        childRecords: (
                            await this.interpretNode(d.child, r, n, i)
                        ).value,
                    }))
                );
...
async function ym() {
    return (
        globalThis.crypto ?? (await Promise.resolve().then(() => (Be(), In)))
    );
}
async function Xa() {
...
\`\`\``
            : "",
        P =
            nt(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
var Mi =
        ...
        (r) => {
            ...
            if (Ur(r))
                ...
                let [o, ...s] = r;
                ((n = o),
                    (i = { values: At(s || []), __prismaRawParameters__: !0 }));
            } else
                switch (t) {
                    case "sqlite":
                    case "mysql": {
