    ...
    getDocument: async ({ params, initiator }) => {
        ...
        const chat = doc.chat
            ? {
                ...
                name: doc.chat.name,
                aiAgentEnabled: doc.chat.aiAgentEnabled,
                aiAgentVisibility: doc.chat.aiAgentVisibility,
    ...
    deleteDocument: async ({ params, initiator }) => {
        ...
        const chat = document.chat
            ? {
                ...
                aiAgentEnabled: document.chat.aiAgentEnabled,
                aiAgentVisibility: document.chat.aiAgentVisibility,
